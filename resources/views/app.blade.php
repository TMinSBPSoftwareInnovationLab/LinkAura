...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <meta property="og:image" content="https://linkaura.co.in/images/linkAuraLogo1200.png">
        <meta property="og:image:secure_url" content="https://linkaura.co.in/images/linkAuraLogo1200.png">
