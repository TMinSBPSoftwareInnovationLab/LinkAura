        ...
        <div  class="max-w-[430px] pb-0 mx-auto grid grid-cols-1  bg-center bg-cover bg-no-repeat ">
            ...
            <div id="Videos" class="mt-0 flex flex-col w-full border-1 border-b-[#52b84a] bg-white px-2 ">
                ...
                <div class="flex flex-col w-full">
                    <!-- Youtube area -->
                    <div class="flex flex-col w-full p-5 mb-2 mt-2">
                        <div v-if="youtube_link1 || youtube_link2" class="flex flex-col gap-4 p-5 mt-2 mb-4 rounded-lg" >
                        <iframe
                            v-if="youtube_link1"
                    ...
                    <!-- insta link area -->
                    <div v-if="instaReals_link1 || instaReals_link2" class="grid grid-cols-1 gap-4 p-5 pt-0 mb-2">
