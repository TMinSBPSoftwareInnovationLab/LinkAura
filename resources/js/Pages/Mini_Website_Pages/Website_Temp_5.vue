            ...
            <div id="home" class="relative flex flex-col w-full bg-white mt-1">
                ...
                <div class="flex flex-col items-center -mt-24 px-4">
                    ...
                    <div class="mt-2 text-center">
                        <h1 class="text-xl font-bold text-black tracking-tight uppercase">Balamurugan S</h1>
                        <p class="text-[16px] font-semibold text-gray-800">Managing Director</p>
                        <p class="text-[16px] font-semibold text-gray-800">Thirumurugam Education Academy</p>
                    </div>
