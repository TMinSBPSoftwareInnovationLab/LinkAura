                ...
                <div class="grid grid-cols-2 gap-4 items-stretch px-1">
                    ...
                    <div v-for="(item, index) in products" :key="index" class="flex flex-col w-full h-full bg-white p-3">
                        ...
                        <div class="w-full h-[200px] md:h-[250px] rounded-[15px] bg-white border border-gray-300 cursor-pointer  relative" @click="openImage(item.product_img)">
                            ...
                            <span v-if="item.status == 1" class="absolute top-0 right-12 bg-orange-500 text-white text-[10px] px-2 py-1 rounded-md font-bold uppercase shadow-sm z-10">
                                Trending
                            </span>
                            
                            <span v-else-if="item.status === 2" class="absolute top-0 right-12 bg-green-600 text-white text-[10px] px-2 py-1 rounded-md font-bold uppercase shadow-sm z-10">
                                New Arrival
                            </span>
