        ...
        <div class="max-w-[430px] pb-0 mx-auto grid grid-cols-1  bg-center bg-cover bg-no-repeat ">
            ...
            <div id="Videos" class="flex flex-col w-full mb-2 shadow-2xl mt-5">
                ...
                <div class="flex flex-col w-full bg-[#f1f1f1]">
                    <!-- Youtube area -->
                    <div class="flex flex-col w-full p-5 bg-gradient-to-bl from-[#ffe4e6]  to-[#ccfbf1] mb-2 mt-2">
                    ...
                    <!-- insta link area -->
                    <div v-if="instaReals_link1 || instaReals_link2" class="grid grid-cols-1 gap-4 p-5 mb-2">
...
<script>
    ...
    import { PaperAirplaneIcon, CurrencyRupeeIcon, RocketLaunchIcon, ChevronLeftIcon, ChevronRightIcon } from '@heroicons/vue/24/solid'
    import WebsiteFooterBar from '../Components/WebsiteFooterBar.vue';

    export default{
        name: "Website_Temp_1",
        components: {PaperAirplaneIcon, CurrencyRupeeIcon, RocketLaunchIcon, WebsiteFooterBar, ChevronLeftIcon, ChevronRightIcon},
        props: {
            // themeId: Number,
            // design: Number,
            isFooter: {
